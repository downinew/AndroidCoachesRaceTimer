...
public class NewAthleteActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		eventSpinner.setAdapter(new ArrayAdapter<String>(this,
		...
		if (getIntent().getStringExtra(AthletesView.EDIT_OR_NEW).equals(
				AthletesView.EDIT) ? true : false) {// If it's an edit
	...
	public void onClick(View v) {
		if (v.getId() == R.id.addButton) {
			...
			returnIntent.putExtra(MainActivity.KEY_FIRST_NAME_STRING,
					firstNameText.getText().toString());
			returnIntent.putExtra(MainActivity.KEY_LAST_NAME_STRING,
					lastNameText.getText().toString());
			returnIntent.putExtra(
					MainActivity.KEY_MAIN_EVENT_STRING,
					eventSpinner.getItemAtPosition(
							eventSpinner.getSelectedItemPosition()).toString());
			returnIntent.putExtra(
					MainActivity.KEY_PR_STRING,
					"" + hour.getText() + ":" + min.getText() + ":"
							+ sec.getText() + "." + ms.getText());
